                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    id="product_id" class="form-select select2"
                                        aria-label="Default select example">
                                        <option selected="">Open this select menu</option>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <i style="background-color: #1B2850"
                                        class="btn text-white btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore">
                                        Add More</i>
                                </div>
                            </div>
