                            ...
                            <tbody>
                                ...
                                @foreach ($customers as $key => $item)
                                    <tr>
                                        <td> {{ ++$key }} </td>
                                        <td> {{ $item->name }} </td>
                                        <td> <img src="{{ $item->customer_img_uri }}" alt="{{ $item->name }}"
                                        ...
                                        <td>
                                            ...
                                            @elseif ($item->status == 0)
                                                <a href="{{ url('customer/status') }}/1/{{ $item->id }}"><span
                                                        class="badges bg-lightred">block</span></a>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('customer.edit', $item->id) }}" class="btn text-primary sm"
                                                title="Edit Data"> <i class="fas fa-edit"></i>
                                            </a>

                                            <a href="{{ route('customer.delete', $item->id) }}" class="btn text-danger sm"
