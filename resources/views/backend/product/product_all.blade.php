                    ...
                    <table id="datatable" class="table table-striped nowrap" style="width:100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
       <a href="{{ route('product.edit',$item->id) }}" class="btn text-success sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>
    
         <a href="{{ route('product.delete',$item->id) }}" class="btn text-danger sm" title="Delete Data" id="delete"> <i class="fas fa-trash-alt"></i></i></a>
